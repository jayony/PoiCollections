...
//        this.cell2 = calcCell(sheet, cell1, size.getCx(), size.getCy());
    ...
    public int getDx1() {
        return MathCompaty.toIntExact(getCell1().getColOff());
    }
    ...
    public int getDy1() {
        return MathCompaty.toIntExact(getCell1().getRowOff());
    }
    ...
    public int getDy2() {
        return MathCompaty.toIntExact(getCell2().getRowOff());
    }
    ...
    public int getDx2() {
        return MathCompaty.toIntExact(getCell2().getColOff());
    }
