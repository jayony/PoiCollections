...
import org.apache.poi.util.DuplicatableUtils;
...
public abstract class TAPAbstractType {
    ...
    protected TAPAbstractType(TAPAbstractType other) {
        ...
        TableCellDescriptor[] tableCellDescriptors = null;
        field_74_rgtc = DuplicatableUtils.copy(other.field_74_rgtc);
        field_75_rgshd = DuplicatableUtils.copy(other.field_75_rgshd);
