...
public interface RelationshipSource {
	 ...
	 */
	public abstract PackageRelationship addRelationship(PackagePartName targetPartName, TargetMode targetMode, String relationshipType);
	 ...
	 */
	public abstract PackageRelationship addRelationship(PackagePartName targetPartName, TargetMode targetMode, String relationshipType, String id);
	 ...
	 * @return The newly created and added relationship
	 * @see RelationshipSource#addExternalRelationship(String, String)
	 */
	 ...
	 */
	public abstract PackageRelationshipCollection getRelationshipsByType(String relationshipType) throws InvalidFormatException,
