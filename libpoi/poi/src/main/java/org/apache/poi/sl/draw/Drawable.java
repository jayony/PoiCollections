...
public interface Drawable {
     ...
     *   {@link java.awt.Graphics2D#drawLayout(java.text.AttributedCharacterIterator, float, float)}.
    ...
    /**
     * draw text via {@link java.awt.Graphics2D#drawLayout(java.text.AttributedCharacterIterator, float, float)}
     */
