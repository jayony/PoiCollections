...
public final class XSSFCell extends CellBase {
    ...
    protected String getCellFormula(BaseXSSFEvaluationWorkbook fpb) {
        ...
        if (f == null) {
            ...
            return convertSharedFormula(MathCompaty.toIntExact(f.getSi()),
    ...
    public XSSFCellStyle getCellStyle() {
        ...
        if(_stylesSource.getNumCellStyles() > 0){
            ...
            style = _stylesSource.getStyleAt(MathCompaty.toIntExact(idx));
        }
        return style;
    }
     ...
     */
    @Override
    public Calendar getCalendarCellValue() {
        if (getCellType() == CellType.BLANK) {
            return null;
        }
        ...
        double value = getNumericCellValue();
        boolean date1904 = getSheet().getWorkbook().isDate1904();
        return DateUtil.getJavaCalendar(value, date1904);
    }
    ...
    */
    ...
    public void updateCellReferencesForShifting(String msg){
        ...
        int sheetId = MathCompaty.toIntExact(getSheet().sheet.getSheetId());
