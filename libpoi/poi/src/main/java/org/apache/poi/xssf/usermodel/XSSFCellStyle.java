 ...
 *
 * @see XSSFWorkbook#createCellStyle()
 * @see XSSFWorkbook#getCellStyleAt(int)
 * @see XSSFCell#setCellStyle(org.apache.poi.ss.usermodel.CellStyle)
 */
public class XSSFCellStyle implements CellStyle, Duplicatable {
    ...
    public BorderStyle getBorderBottom() {
        ...
        int idx = MathCompaty.toIntExact(_cellXf.getBorderId());
     ...
     * @see XSSFWorkbook#getFontAt(short)
     */
    @Override
    @Deprecated
     ...
     *
     * @return short - font index
     * @see XSSFWorkbook#getFontAt(int)
     * @since 4.0.0
     */
    @Override
