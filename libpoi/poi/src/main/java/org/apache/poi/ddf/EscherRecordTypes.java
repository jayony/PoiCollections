...
public enum EscherRecordTypes {
    ...
    private static final Map<Short, EscherRecordTypes> LOOKUP = lookup();

    private static Map<Short, EscherRecordTypes> lookup() {
        Map<Short, EscherRecordTypes> map = new HashMap<>();
        for (EscherRecordTypes value : values()) {
