...
public abstract class PropertyNode<T extends PropertyNode<T>> implements Comparable<T>, Duplicatable {
    ...
    public static final Comparator<PropertyNode<?>> EndComparator = new Comparator<PropertyNode<?>>() {
        @Override
    ...
    public static final Comparator<PropertyNode<?>> StartComparator = new Comparator<PropertyNode<?>>() {
        @Override
        public int compare(PropertyNode<?> o1, PropertyNode<?> o2) {
