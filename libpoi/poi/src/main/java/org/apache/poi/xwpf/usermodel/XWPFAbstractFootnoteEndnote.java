...
public abstract class XWPFAbstractFootnoteEndnote  implements Iterable<XWPFParagraph>, IBody {
     ...
     *
     * @param ctTable
     * @see IBody#getTable(CTTbl ctTable)
     */
     ...
     *
     * @see IBody#getParagraphArray(int pos)
     */
     ...
     * @see IBody#getTableCell(CTTc cell)
     */
     ...
     * @see IBody#insertNewTbl(XmlCursor cursor)
     */
     ...
     * @see IBody#insertNewParagraph(XmlCursor cursor)
     */
