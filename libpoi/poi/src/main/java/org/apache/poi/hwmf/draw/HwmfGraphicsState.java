...
/**
 * An util class for saving the state of a {@link Graphics2D} object
 */
@Internal
public class HwmfGraphicsState {
    ...
    private PoiFont font;
    private PoiPaint poiPaint;
    ...
    public void backup(Graphics2D graphics2D) {
        ...
        font = graphics2D.getPoiFont();
        poiPaint = graphics2D.getPoiPaint();
    ...
    public void restore(Graphics2D graphics2D) {
        ...
        graphics2D.setPoiFont(font);
        graphics2D.setPoiPaint(poiPaint);
