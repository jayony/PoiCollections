...
public final class XSSFPasswordHelper {
    ...
    public static void setPassword(XmlObject xobj, String password, HashAlgorithm hashAlgo, String prefix) {
        ...
        if (hashAlgo == null) {
            ...
            cur.insertAttributeWithValue(getAttrName(prefix, "hashValue"), base64.encodeToString(hash));
            cur.insertAttributeWithValue(getAttrName(prefix, "saltValue"), base64.encodeToString(salt));
    ...
    public static boolean validatePassword(XmlObject xobj, String password, String prefix) {
        ...
        if (xorHashVal != null) {
            ...
            Base64 base64 = new Base64();
            byte[] hash1 = base64.decode(hashVal);
            HashAlgorithm hashAlgo = HashAlgorithm.fromString(algoName);
            byte[] salt = base64.decode(saltVal);
