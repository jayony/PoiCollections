...
public class DrawTextShape extends DrawSimpleShape {
    ...
    public void drawContent(Graphics2D graphics) {
        ...
        drawParagraphs(graphics, x, y, false);
     ...
     */
    public double drawParagraphs(Graphics2D graphics, double x, double y, boolean calculateHeight) {
        ...
        for (int autoNbrIdx=0; paragraphs.hasNext(); autoNbrIdx++){
            ...
            isFirstLine = false;
            dp.setCalculateHeight(calculateHeight);
            dp.setPosition(x, y);
            dp.draw(graphics);
            y += dp.getY();
