    ...
    public void draw(Graphics2D graphics) {
        ...
        for (int row=0; row<rows; row++) {
            for (int col=0; col<cols; col++) {
                ...
                PoiPaint fillPoiPaint = drawPaint.getPaint(graphics, tc.getFillStyle().getPaint());
                graphics.setPoiPaint(fillPoiPaint);
                ...
                for (BorderEdge edge : BorderEdge.values()) {
                    ...
                    PoiPaint linePoiPaint = drawPaint.getPaint(graphics, stroke.getPaint());
                    graphics.setPoiPaint(linePoiPaint);
