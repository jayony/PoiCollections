...
public enum EscherPropertyTypes {
    ...
    private static final Map<Short, EscherPropertyTypes> LOOKUP = lookup();

    private static Map<Short, EscherPropertyTypes> lookup() {
        Map<Short, EscherPropertyTypes> map = new LinkedHashMap<>();
        for (EscherPropertyTypes value : values()) {
            map.put(value.getPropertyId(), value);
        }
        return map;
    }
