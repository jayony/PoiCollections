...
public class XDDFFont {
    ...
    public static XDDFFont unsetFontForGroup() {
        return new XDDFFont(null);
    }

    public XDDFFont(String typeface, Byte charset, Byte pitch, byte[] panose) {
        this(CTTextFont.Factory.newInstance());
        if (typeface == null) {
    ...
    @Internal
    protected XDDFFont(CTTextFont font) {
        this.font = font;
    }
