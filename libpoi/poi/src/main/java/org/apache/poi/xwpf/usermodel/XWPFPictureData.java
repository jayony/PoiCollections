...
public class XWPFPictureData extends POIXMLDocumentPart {
     ...
     *
     * @return an integer constant that specifies type of this picture
     * @see Document#PICTURE_TYPE_EMF
     * @see Document#PICTURE_TYPE_WMF
     * @see Document#PICTURE_TYPE_PICT
     * @see Document#PICTURE_TYPE_JPEG
     * @see Document#PICTURE_TYPE_PNG
     * @see Document#PICTURE_TYPE_DIB
     */
