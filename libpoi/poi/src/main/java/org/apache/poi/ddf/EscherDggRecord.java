...
public final class EscherDggRecord extends EscherRecord {
    ...
    public EscherDggRecord(EscherDggRecord other) {
        ...
        for (FileIdCluster cluster : other.field_5_fileIdClusters) {
            field_5_fileIdClusters.add(new FileIdCluster(cluster));
        }
    ...
    private void sortCluster() {
        Collections.sort(field_5_fileIdClusters, FileIdCluster::compareFileIdCluster);
    }
